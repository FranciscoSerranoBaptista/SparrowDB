...
fn test_dijkstra_custom_weight_function() {
    ...
    let custom_weight = |edge: &crate::utils::items::Edge,
        ...
        edge.properties
            ...
            .ok_or_else(|| {
                crate::sparrow_engine::types::GraphError::TraversalError(
...
fn test_astar_with_property_heuristic() {
    use crate::sparrow_engine::traversal_core::ops::util::paths::property_heuristic;
...
fn test_astar_custom_weight_and_heuristic() {
    ...
    let custom_weight = |edge: &crate::utils::items::Edge,
        ...
        let distance = edge
            ...
            .ok_or(crate::sparrow_engine::types::GraphError::New(
