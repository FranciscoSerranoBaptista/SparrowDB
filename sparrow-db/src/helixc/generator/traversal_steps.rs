    ...
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        match &self.weight_calculation {
            ...
            WeightCalculation::Default => {
                write!(
                    f,
                    "sparrow_db::helix_engine::traversal_core::ops::util::paths::default_weight_fn"
                )?;
            }
        }
...
impl Display for ShortestPathBFS {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        write!(
            f,
            "shortest_path_with_algorithm({}, {}, {}, PathAlgorithm::BFS, sparrow_db::helix_engine::traversal_core::ops::util::paths::default_weight_fn)",
            self.label
                .as_ref()
                .map_or("None".to_string(), |label| format!("Some({label})")),
            self.from
...
impl Display for ShortestPathAStar {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        write!(
            f,
            "|node| sparrow_db::helix_engine::traversal_core::ops::util::paths::property_heuristic(node, {})",
