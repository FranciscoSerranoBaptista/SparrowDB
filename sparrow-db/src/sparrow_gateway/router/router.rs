...
use crate::{
    sparrow_engine::{traversal_core::SparrowGraphEngine, types::GraphError},
...
pub struct HandlerInput {
    pub request: Request,
    pub graph: Arc<SparrowGraphEngine>,
}
...
mod tests {
    ...
    fn test_router_new_empty() {
        let router = SparrowRouter::new(None, None, None);
    ...
    fn test_router_new_with_routes() {
        ...
        let router = SparrowRouter::new(Some(routes), None, Some(write_routes));
    ...
    fn test_router_is_write_route_true() {
        ...
        let router = SparrowRouter::new(None, None, Some(write_routes));
    ...
    fn test_router_add_route_basic() {
        let mut router = SparrowRouter::new(None, None, None);
