...
use crate::{sparrow_engine::types::VectorError, utils::properties::ImmutablePropertiesMap};
...
pub trait HNSW {
    ...
    where
        F: Fn(&HVector<'arena>, &rocksdb::Transaction<'db, rocksdb::TransactionDB>) -> bool,
        'db: 'arena,
        'arena: 'txn;
