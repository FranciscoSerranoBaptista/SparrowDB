...
mod mcp_tests {
    ...
    fn execute_query_chain_out_step_returns_neighbor() {
        ...
        let stream =
            crate::sparrow_gateway::mcp::tools::execute_query_chain(&steps, storage, &txn, &arena)
                .unwrap();
    ...
    fn mcp_connection_next_advances_position() {
        ...
        assert!(!matches!(
            first,
            crate::sparrow_engine::traversal_core::traversal_value::TraversalValue::Empty
        ));
    ...
    fn test_mcp_handlers_are_registered() {
        use crate::sparrow_gateway::mcp::mcp::MCPHandlerSubmission;
    ...
    fn test_out_step_handler_http() {
        use crate::sparrow_gateway::mcp::mcp::out_step;
    ...
    fn test_in_step_handler_http() {
        use crate::sparrow_gateway::mcp::mcp::in_step;
    ...
    fn test_out_e_step_handler_http() {
        use crate::sparrow_gateway::mcp::mcp::out_e_step;
    ...
    fn test_in_e_step_handler_http() {
        use crate::sparrow_gateway::mcp::mcp::in_e_step;
    ...
    fn test_n_from_type_handler_http() {
        use crate::sparrow_gateway::mcp::mcp::n_from_type;
    ...
    fn test_e_from_type_handler_http() {
        use crate::sparrow_gateway::mcp::mcp::e_from_type;
    ...
    fn test_filter_items_handler_http() {
        use crate::sparrow_gateway::mcp::mcp::filter_items;
    ...
    fn test_order_by_handler_http() {
        use crate::sparrow_gateway::mcp::mcp::order_by;
    ...
    fn test_order_by_ascending() {
        ...
        let steps = vec![
            ...
            ToolArgs::OrderBy {
                ...
                order: crate::sparrow_gateway::mcp::tools::Order::Asc,
            },
        ];
    ...
    fn test_order_by_descending() {
        ...
        let steps = vec![
            ...
            ToolArgs::OrderBy {
                properties: "age".to_string(),
                order: crate::sparrow_gateway::mcp::tools::Order::Desc,
            },
        ];
    ...
    fn test_search_keyword_handler_http() {
        use crate::sparrow_gateway::mcp::mcp::search_keyword;
    ...
    fn test_search_vector_handler_http() {
        use crate::sparrow_gateway::mcp::mcp::search_vector;
    ...
    fn test_search_vector_text_handler_http() {
        use crate::sparrow_gateway::mcp::mcp::search_vector_text;
