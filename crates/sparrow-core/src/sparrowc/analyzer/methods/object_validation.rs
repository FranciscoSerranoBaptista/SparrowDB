...
use crate::sparrowc::analyzer::utils::DEFAULT_VAR_NAME;
use crate::sparrowc::analyzer::{
    error_codes::ErrorCode, errors::push_query_err, utils::get_field_type_from_item_fields,
};
use crate::sparrowc::generator::source_steps::SourceStep;
use crate::sparrowc::parser::errors::ParserError;
use crate::{
    generate_error,
    sparrowc::{
        analyzer::{
...
fn mark_vector_steps_for_data_fetch(gen_traversal: &mut GeneratedTraversal) {
    use crate::sparrowc::generator::traversal_steps::{EdgeType, Step};
    use crate::sparrowc::generator::utils::Separator;
...
pub(crate) fn validate_object<'a>(
    ...
    scope: &mut std::collections::HashMap<&'a str, crate::sparrowc::analyzer::utils::VariableInfo>,
    gen_query: &mut crate::sparrowc::generator::queries::Query,
                ...
                for field_addition in &obj.fields {
                    match &field_addition.value.value {
                        ...
                        FieldValueType::Traversal(tr) => {
                            ...
                            use crate::sparrowc::analyzer::methods::traversal_validation::validate_traversal;
                            use crate::sparrowc::generator::traversal_steps::NestedTraversalInfo;
                            use crate::sparrowc::parser::types::StartNode;
                            ...
                            let mut nested_gen_traversal =
                                crate::sparrowc::generator::traversal_steps::Traversal::default();
                            ...
                            let own_closure_param =
                                tr.steps.last().and_then(|step| match &step.step {
                                    crate::sparrowc::parser::types::StepType::Closure(cl) => {
                        ...
                        FieldValueType::Expression(expr) => {
                            ...
                            use crate::sparrowc::analyzer::methods::traversal_validation::validate_traversal;
                            use crate::sparrowc::generator::traversal_steps::{
                                ComputedExpressionInfo, NestedTraversalInfo,
                            };
                            use crate::sparrowc::parser::types::ExpressionType;
                            ...
                            if let ExpressionType::MathFunctionCall(_) = &expr.expr {
                                ...
                                if let ExpressionType::Identifier(id) = &expr.expr {
                                    if let Some(var_info) = scope.get(id.as_str()) {
                                        ...
                                        let nested_info = NestedTraversalInfo {
                                            traversal: Box::new(crate::sparrowc::generator::traversal_steps::Traversal::default()),
...
#[cfg(test)]
mod tests {
    use crate::sparrowc::parser::{SparrowParser, write_to_temp_file};
