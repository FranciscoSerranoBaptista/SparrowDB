                ...
                let (inner_traversal, weight_expr_typed) = if let Some(expr) = weight_expression {
                    ...
                    let weight_type = match &expr.expr {
                        ExpressionType::Traversal(_trav) => {
                            ...
                            Some(crate::sparrowc::parser::types::WeightExpression::Expression(
                                Box::new(expr.clone()),
                            ))
                        }
                        ...
                        _ => Some(crate::sparrowc::parser::types::WeightExpression::Expression(
                            Box::new(expr.clone()),
                        )),
                    };
                    (None, weight_type)
                    ...
                    (
                        None,
                        Some(crate::sparrowc::parser::types::WeightExpression::Default),
                    )
                };
