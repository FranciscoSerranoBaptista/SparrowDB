...
fn check_duplicate_schema_definitions(ctx: &mut Ctx) -> Result<(), ParserError> {
    ...
    let mut seen_nodes: HashMap<String, (crate::sparrowc::parser::location::Loc, String)> =
        HashMap::new();
    let mut seen_edges: HashMap<String, (crate::sparrowc::parser::location::Loc, String)> =
        HashMap::new();
    let mut seen_vectors: HashMap<String, (crate::sparrowc::parser::location::Loc, String)> =
        HashMap::new();
