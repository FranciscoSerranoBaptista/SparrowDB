...
use crate::sparrow_engine::traversal_core::ops::source::add_e::AddEAdapter;
...
use crate::{sparrow_engine::traversal_core::ops::source::e_from_type::EFromTypeAdapter, props};
use crate::{
    sparrow_engine::traversal_core::ops::source::n_from_type::NFromTypeAdapter,
