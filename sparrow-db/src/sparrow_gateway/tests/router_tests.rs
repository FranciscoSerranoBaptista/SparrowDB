use crate::{
    ...
    sparrow_gateway::router::router::{
        Handler, HandlerFn, HandlerInput, HandlerSubmission, SparrowRouter, RouterError,
    },
...
fn test_router_new_with_routes() {
    ...
    let router = SparrowRouter::new(Some(routes), None, None);
