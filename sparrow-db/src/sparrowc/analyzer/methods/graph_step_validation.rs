...
use crate::sparrowc::analyzer::utils::{VariableInfo, type_in_scope, validate_embed_string_type};
use crate::sparrowc::generator::traversal_steps::EdgeType;
use crate::sparrowc::generator::utils::EmbedData;
use crate::{
    generate_error,
    sparrowc::{
        analyzer::{
                    ...
                    if let Some(edge_fields) = ctx.edge_fields.get(edge_type.as_str()) {
                        if let Some(field) = edge_fields.get(weight_prop.as_str()) {
                            ...
                            match &field.field_type {
                                crate::sparrowc::parser::types::FieldType::F32
                                | crate::sparrowc::parser::types::FieldType::F64
                                | crate::sparrowc::parser::types::FieldType::I8
                                | crate::sparrowc::parser::types::FieldType::I16
                                | crate::sparrowc::parser::types::FieldType::I32
                                | crate::sparrowc::parser::types::FieldType::I64
                                | crate::sparrowc::parser::types::FieldType::U8
                                | crate::sparrowc::parser::types::FieldType::U16
                                | crate::sparrowc::parser::types::FieldType::U32
                                | crate::sparrowc::parser::types::FieldType::U64
                                | crate::sparrowc::parser::types::FieldType::U128 => {
