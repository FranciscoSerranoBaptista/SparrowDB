...
use crate::{
    sparrow_engine::types::{GraphError, VectorError},
...
impl SparrowError {
    fn code(&self) -> &'static str {
        match self {
            SparrowError::Graph(_) => "GRAPH_ERROR",
...
impl IntoResponse for SparrowError {
    fn into_response(self) -> axum::response::Response {
        let status = match &self {
            ...
            | SparrowError::Vector(VectorError::VectorNotFound(_)) => {
