use crate::sparrowc::analyzer::error_codes::*;
use crate::sparrowc::analyzer::utils::{
        ...
        match step {
                    ...
                    GeneratedStatement::Traversal(tr) => {
                        gen_traversal
                            ...
                            .push(Separator::Period(GeneratedStep::Intersect(
                                crate::sparrowc::generator::traversal_steps::Intersect {
                                    traversal: tr,
                                },
                            )));
            ...
            StepType::RerankRRF(rerank_rrf) => {
                ...
                gen_traversal
                    ...
                    .push(Separator::Period(GeneratedStep::RerankRRF(
                        crate::sparrowc::generator::traversal_steps::RerankRRF { k },
                    )));
            }
            StepType::RerankMMR(rerank_mmr) => {
                ...
                let distance = if let Some(MMRDistance::Identifier(id)) = &rerank_mmr.distance {
                    ...
                    Some(
                        crate::sparrowc::generator::traversal_steps::MMRDistanceMethod::Identifier(
                            id.clone(),
                        ),
                    )
                } else {
                    rerank_mmr.distance.as_ref().map(|d| match d {
                        MMRDistance::Cosine => {
                            crate::sparrowc::generator::traversal_steps::MMRDistanceMethod::Cosine
                        }
                        MMRDistance::Euclidean => {
                            crate::sparrowc::generator::traversal_steps::MMRDistanceMethod::Euclidean
                        }
                        MMRDistance::DotProduct => {
                            crate::sparrowc::generator::traversal_steps::MMRDistanceMethod::DotProduct
                        }
                ...
                gen_traversal
                    ...
                    .push(Separator::Period(GeneratedStep::RerankMMR(
                        crate::sparrowc::generator::traversal_steps::RerankMMR { lambda, distance },
                    )));
            }
        }
...
#[cfg(test)]
mod tests {
    use crate::sparrowc::analyzer::error_codes::ErrorCode;
    use crate::sparrowc::generator::statements::Statement as GeneratedStatement;
